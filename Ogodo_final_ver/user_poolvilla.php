<?php
        ...
        echo"List of Poolvilla";
        $q = "SELECT * FROM accommodatiom WHERE ac_type='Pool villa' ORDER BY rating DESC;";
        ...
        if($result= $connect->query($q)){
           ...
           while($row= $result->fetch_array()){
               ...
               echo "<td><a href='fav_pool.php?id=".$row['ac_id']."'>Favorites</a></td>";
               echo"</tr>";
           }
           echo '</table>';
           $result->free();
